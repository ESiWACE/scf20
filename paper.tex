...
In HPC, the concerns of storage and computing are traditionally separated and optimised independently from each other and the needs of the end-to-end user. Still, in complex workflows, this is becoming problematic. These problems are particularly acute in climate and weather workflows, which as well as become increasingly complex and exploiting deep storage hierarchies, can involve multiple data centres.
...
In total, at the Met Office, on average 1.5\,PB and 14\,PB per day are written and read, respectively, for all climate and weather forecasts across all HPC clusters.
