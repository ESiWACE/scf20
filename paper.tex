...
iRODS~\cite{rajasekar2010irods} is a rule-oriented data system that allows scientists to organise data into shareable collections and provide metadata such as the data life cycle. \lr{such as information about the data life cycle?}
iRODS provides several patterns for workflows that consider data locality and data migration/replication.
...
We thank our collaborators Bryan Lawrence, Glenn Greed, David Matthews, and Hua Huang for their input to this article.
