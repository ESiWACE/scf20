...
\item[Data Migration] is the process of transferring data from one storage system to another; typically this involves to delete the data but this decision can be delayed to provide read access on multiple storage systems.
...
\begin{enumerate}
  ...
  \item \textbf{Scientist} The user now has to provide an additional file that covers the I/O information for each task and slightly changes have to be made to the current scripts.
