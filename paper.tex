...
The scientists make the configuration about parallelism and data location in the script file that is executed for each specific task.
...
Once we have an automated decision about where the job will run and how the storage will be managed, scientists can then run their workflows on any system without further modification and even without previous knowledge about the system architecture.
